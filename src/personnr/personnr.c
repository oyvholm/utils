 ...
 *
 * $Id: personnr.c,v 1.5 2004/03/03 09:29:47 sunny Exp $
 *
...
#define VERSION   "1.12"
#define RCS_DATE  "$Date: 2004/03/03 09:29:47 $"
...
static char rcs_id[] = "$Id: personnr.c,v 1.5 2004/03/03 09:29:47 sunny Exp $";
