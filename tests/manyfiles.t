...
#=======================================================================
# manyfiles.t
# File ID: 24f90ba2-f988-11dd-924a-000475e441b9
# Test suite for manyfiles(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = "manyfiles-stderr.tmp";
...
Contains tests for the manyfiles(1) program.
...
manyfiles.t [options] [file [files [...]]]
