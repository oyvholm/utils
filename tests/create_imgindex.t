...
#=======================================================================
# create_imgindex.t
# File ID: f9bf79d0-1e08-11de-8f7a-000475e441b9
# Test suite for create_imgindex(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = 'create_imgindex-stderr.tmp';
...
Contains tests for the create_imgindex(1) program.
...
create_imgindex.t [options] [file [files [...]]]
