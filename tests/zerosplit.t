...
#=======================================================================
# $Id$
# File ID: b58f167a-f988-11dd-ae65-000475e441b9
# Test suite for zerosplit(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = "zerosplit-stderr.tmp";
...
Contains tests for the zerosplit(1) program.
...
zerosplit.t [options] [file [files [...]]]
