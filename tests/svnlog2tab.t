...
#=======================================================================
# svnlog2tab.t
# File ID: 8925901e-f988-11dd-91a8-000475e441b9
# Test suite for svnlog2tab(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = "svnlog2tab-stderr.tmp";
...
Contains tests for the svnlog2tab(1) program.
...
svnlog2tab.t [options] [file [files [...]]]
