...
=cut
    ...
    coreutils(qw{
        ...
        tail tee timeout touch tr true truncate tsort tty uname unexpand uniq 
    ...
    installed('git --version', '/^git version 2\.15/', 'stdout');
    ...
    installed('sqlite3 --version', '/^3\.20\.1 2017-08-24 16:21:36/', 'stdout');
