...
#=======================================================================
# html2db.t
# File ID: 12be826e-f988-11dd-807a-000475e441b9
# Test suite for html2db(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = "html2db-stderr.tmp";
...
Contains tests for the html2db(1) program.
