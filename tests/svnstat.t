...
#=======================================================================
# svnstat.t
# File ID: 8e1bde16-f988-11dd-859a-000475e441b9
# Test suite for svnstat(1).
#
# Character set: UTF-8
...
sub testcmd {
    ...
    my $TMP_STDERR = 'svnstat-stderr.tmp';
...
Contains tests for the svnstat(1) program.
